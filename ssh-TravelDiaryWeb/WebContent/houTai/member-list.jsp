...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="r">共有数据：<strong>${fn:length(uList)}</strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach items="${uList}"   var = "user">
			<tr class="text-c">
				...
				<td>${user.email}</td>
				<td>${user.site}</td>
				<td class="text-l">${user.individualResume}</td>
				...
				<a title="删除" href="javascript:;" onclick="member_del(this,${user.id})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
